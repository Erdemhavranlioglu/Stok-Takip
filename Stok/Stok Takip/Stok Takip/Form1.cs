...
namespace Stok_Takip
{
    ...
    {
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-65GVH95\\SQLEXPRESS;Initial Catalog=StokTakip;Integrated Security=True");
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                komut5.Parameters.AddWithValue("@a2",Convert.ToInt32(txtKalanMiktar.Text));
                komut5.Parameters.AddWithValue("@a3",Convert.ToInt32(txtKategoriNo.Text));
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                komut7.Parameters.AddWithValue("@a2",Convert.ToInt32(txtKalanMiktar.Text));
                komut7.Parameters.AddWithValue("@a3", txtAlisFiyati.Text);
                komut7.Parameters.AddWithValue("@a4", txtSatisFiyati.Text);
                komut7.Parameters.AddWithValue("@a5",Convert.ToInt32(txtKategoriNo.Text));
